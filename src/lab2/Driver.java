...
//		task2 and 3
		...
		Room room2 = new Room(50, 50, Color.green);
		Room room3 = new Room(50, 50, Color.darkGray);
		Room room4 = new Room(50, 50, Color.pink);
		Room room5 = new Room(50, 50, Color.red);
		Room room6 = new Room(50, 50, Color.yellow);
